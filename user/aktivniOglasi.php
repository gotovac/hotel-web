...
$sqlOglasi = "SELECT * FROM oglasi WHERE status = 'Aktivan'";
...
while ($row = $oglasi->fetch_assoc()) {
    $table = $table . "<tr> <td>" . $row["oglas_id"] . "</td>" . "<td>" . $row["naziv"] . "</td>" . "<td>" . $row["pocetak"] . "</td>" . "<td>" . $row["url"] . "</td>" . "<td>" . $row["slika_url"] . "</td>" . "<td><a href='blokirajOglas.php?id=" . $row["oglas_id"] . "'>Zahtjev za blokiranje</a></td>" . "</tr>";
}
